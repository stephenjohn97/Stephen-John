...
public class StatusBarPage extends BasePages {
	public StatusBarPage(ExtentTest test) {
...
//		assertEquals(unavailable, "In Meeting", "Verified 'In meeting' successfully");
//
//		// At Lunch
//		tapOn("Status arrow", statusBarArrow);
...
//		tapOn("Done", statusDone);
//		assertEquals(unavailable, "At Lunch", "Verified 'At Lunch' successfully");
//
//		// On Vacation (1 day)
//		tapOn("Status arrow", statusBarArrow);
...
//		assertEquals(unavailable, "On Vacation", "Verified 'On Vacation' successfully");
//		assertEqualsString(validateAppTime(statusDescription), deviceDateDay_1, "1 day validation successful");
//
//		// On Vacation (2 days)
//		tapOn("Status arrow", statusBarArrow);
//		tapOn("On Vacation", onVacationStatus);
...
//		assertEquals(unavailable, "On Vacation", "Verified 'On Vacation' successfully");
//		assertEqualsString(validateAppTime(statusDescription), deviceDateDays_2, "2 days validation successful");
//
//		// On Vacation (1 week)
//		tapOn("Status arrow", statusBarArrow);
//		tapOn("On Vacation", onVacationStatus);
...
//		assertEquals(unavailable, "On Vacation", "Verified 'On Vacation' successfully");
//		assertEqualsString(validateAppTime(statusDescription), deviceDateWeek_1, "1 week validation successful");
//
//		// custom
//		tapOn("Status arrow", statusBarArrow);
...
//		tapOn("Done", statusDone);
//		assertEquals(unavailable, "On leave undefinitely", "Verified 'On leave undefinitely' successfully");
//
//		tapOn("Status arrow", statusBarArrow);
//		tapOn("On Vacation", onVacationStatus);
//		tapOn("On Custom", custom);

//		WebElement element = driver.findElement(By.id("com.answerconnect.mobile:id/daysPicker"));
//		boolean bool = (boolean) ((JavascriptExecutor) driver).executeScript("mobile: flingGesture",
//				ImmutableMap.of("elementId", ((RemoteWebElement) element).getId(), "direction", "down", "speed", 500));


//		WebElement element1 = driver.findElement(By.id("com.answerconnect.mobile:id/hoursPicker"));
//		((JavascriptExecutor) driver).executeScript("mobile: flingGesture",
//				ImmutableMap.of("elementId", ((RemoteWebElement) element1).getId(), "direction", "down", "speed", 500));
//
//		WebElement element2 = driver.findElement(By.id("com.answerconnect.mobile:id/minutesPicker"));
//		((JavascriptExecutor) driver).executeScript("mobile: flingGesture",
//				ImmutableMap.of("elementId", ((RemoteWebElement) element2).getId(), "direction", "down", "speed", 500));
//
//		WebElement element3 = driver.findElement(By.id("com.answerconnect.mobile:id/amPmPicker"));
//		((JavascriptExecutor) driver).executeScript("mobile: flingGesture",
//				ImmutableMap.of("elementId", ((RemoteWebElement) element3).getId(), "direction", "down", "speed", 500));
//		tapOn("Done", statusDone);
	}
}